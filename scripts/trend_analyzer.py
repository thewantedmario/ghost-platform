...
def get_real_trends():
    ...
    params = {
        ...
        "query": "useful developer web tools trending 2026",
        "results": 10
    }
    ...
    try:
        ...
        # High-intent tools for the $10/day revenue plan
...
def update_generator():
    # 2. CREATE TOOLS DIR IF IT DOESN'T EXIST
    if not os.path.exists(TOOLS_DIR):
        os.makedirs(TOOLS_DIR)

    # 3. DUPLICATE CHECK: Get slugs of everything we already have
    ...
    # 5. FILTER: Only pick ideas that aren't already there
    to_build = []
    ...
    if to_build:
        ...
        # FIX: Added encoding="utf-8" to prevent the UnicodeDecodeError
        ...
        # FIX: Added encoding="utf-8" to prevent the UnicodeDecodeError on save
